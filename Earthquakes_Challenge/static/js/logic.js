...
// create the earthquake/plate layer for our map.
...
// Accessing the tectonic plates GSON data
let plate_data = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
...
// Grabbing our GeoJSON data.
d3.json(plate_data).then(function(data) {
  console.log(data);
// Creating a GeoJSON layer with the retrieved data.
  L.geoJson(data,{
    style: plate_style,
